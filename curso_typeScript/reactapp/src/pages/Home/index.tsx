...
export function Home() {
  ...
  const [students, setStudens] = useState<CardProps[]>([]) //Criando uma lista de estudantes
  const [user, setUser] = useState<User>({} as User) // Começa com objeto vazio e o padrao é user
